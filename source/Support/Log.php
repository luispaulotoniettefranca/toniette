...
class Log extends Logger
{
    ...
    public function __construct()
    {
        ...
        if (CONF_DEBUG) {
            ...
            $this->pushHandler(new StreamHandler(CONF_LOG_PATH."/info_log.txt", Logger::INFO));
        } else {
            $this->pushHandler(new StreamHandler(CONF_LOG_PATH."/error_log.txt", Logger::WARNING));
