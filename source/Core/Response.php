...
class Response
{
     ...
     * @var array|string[]
     */
    private static array $httpStatusCodes = array(100 => "Continue", 101 => "Switching Protocols",
    ...
    420 => "Enhance Your Calm", 422 => "Unprocessable Entity", 423 => "Locked", 424 => "Method Failure",
     ...
     */
    public function json(mixed $data, int $code = 200, ?string $message = null)
    {
        header("Content-type: application/json; charset=UTF-8");
        http_response_code($code);
        header("HTTP/1.1" . ' ' .
            $code . ' ' . (is_null($message) ? self::$httpStatusCodes[$code] : $message));
     ...
     */
    public function view(string $template = "home", array $data = [], string $seo = null)
    {
        $data["seo"] = $seo;
        header("Content-type: text/html; charset=UTF-8");
        $view = new \League\Plates\Engine(CONF_TEMPLATE_ENGINE_PATH,
            CONF_TEMPLATE_ENGINE_EXTENSION);
